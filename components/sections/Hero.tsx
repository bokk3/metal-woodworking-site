  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-darkBg">
      ...
      <div className="absolute inset-0">
        ...
        {/* Subtle Grid Pattern */}
        <div className="absolute inset-0 bg-size-[4rem_4rem] bg-[linear-gradient(to_right,#27272a_1px,transparent_1px),linear-gradient(to_bottom,#27272a_1px,transparent_1px)] mask-[radial-gradient(ellipse_60%_50%_at_50%_0%,#000_70%,transparent_100%)] opacity-10 mix-blend-overlay pointer-events-none" />

        {/* Radial Gradient for depth - lighter overlay, only at edges */}
        <div 
          className="absolute inset-0 pointer-events-none"
          style={{
            background: 'radial-gradient(ellipse at center, transparent 0%, transparent 50%, rgba(10, 10, 10, 0.3) 100%)'
          }}
        />
      </div>
      ...
      <div className="container relative z-[10] px-4 mx-auto text-center">
        ...
        >
          <h1 className={cn(typography.h1, "text-white mb-6")}>
            Crafting <span className="text-gray-300 drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)]">Metal</span> &{" "}
